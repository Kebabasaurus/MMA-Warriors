...
Start with the [documentation index](docs/README.md) for current plans, developer
...
See [the ranked 101–200 portrait review](docs/FIGHTER_PORTRAIT_TOP_200_REVIEW.md).
...
identities are not rewritten. See [the ranked 201–300 portrait review](docs/FIGHTER_PORTRAIT_TOP_300_REVIEW.md).
...
The user-approved [survival expansion](docs/FIGHT_SURVIVAL_EXPANSION.md) adds 40 recovery
...
The [move concentration investigation](docs/FIGHT_MOVE_CONCENTRATION_PLAN.md) explains
...
The [kick-power trial](docs/FIGHT_KICK_POWER_TRIAL.md) adds 1% resolved kick power on top
...
The [submission development report](docs/FIGHT_SUBMISSION_DEVELOPMENT.md) records separate
...
The [unused-move repair report](docs/FIGHT_UNUSED_MOVE_REPAIR.md) records three named
...
are unchanged. The [opportunity-based variety review](docs/FIGHT_VARIETY_TARGET_REVIEW.md)
...
The [completed combination trial](docs/FIGHT_BOXING_COMBINATION_TRIAL.md) increases sampled
...
The [completed timing investigation](docs/FIGHT_JAB_TIMING_INVESTIGATION.md) finds 25 gained
...
The [completed repertoire trial](docs/FIGHT_REPERTOIRE_TRIAL.md) improves competitive
...
The [scarf-hold investigation](docs/FIGHT_SCARF_COVERAGE_INVESTIGATION.md) traces lost
...
The [completed refinement](docs/FIGHT_GIFT_WRAP_TRIAL.md) improves gift-wrap completions
...
The [completed single-root trial](docs/FIGHT_GIFT_WRAP_TRIAL.md) raises gift-wrap root
...
The [live audit findings](docs/FIGHT_CHAIN_SELECTION_AUDIT.md) show 968 different-action
...
See the [fight release checkpoint](docs/FIGHT_RELEASE_CHECKPOINT.md) for the current
...
See [the working plan](docs/FIGHT_MOVE_SYSTEM_PLAN.md).
...
promotion; see the [standing opportunity audit](docs/FIGHT_STANDING_OPPORTUNITY_AUDIT.md).
...
- Book main cards, prelims, early prelims, title fights, TBA fights, and career-affecting 4/8/16-fighter MMA tournaments. Ordinary tournaments remain one-night by default; Grand Prix entries can be spread across 1–4 event cards within their bracket limits. Tournament entrants are seeded by rank, use the normal camp and weigh-in system, accumulate fatigue between rounds, can crown a champion in the final, and remain reserved from other bookings. Injuries or confirmed drug failures use normal eligible replacements or move the whole Grand Prix, and tournament draws use a tournament-only 15-minute decider with judges selecting a winner at the limit.
...
- Fight-engine changes are guarded by a frozen 3,840-bout audit corpus, a focused regression suite,
  ...
  The next expansion follows [the Fight Move System Plan](docs/FIGHT_MOVE_SYSTEM_PLAN.md).
  ...
  [The move schema guide](docs/FIGHT_MOVE_SCHEMA.md) documents every field and the punch, kick,
