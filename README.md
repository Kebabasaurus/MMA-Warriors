...
Version 3.0.6 adds player-funded MMA AI child promotions with configurable startup capital, Youth Prospects/Big Names/Merit strategy, parent profit sharing, and protected fighter loans and recalls. It also expands combat-sports divisions to a complete youth-prospect market, adds established free agents and contract workflows, repairs division-frame mismatches, strengthens regional title, booking, fight-night, and excitement systems, and turns staff into contract-based specialists with meaningful effects. See [CHANGELOG.md](CHANGELOG.md) for the complete release notes.
...
## Version 3.0.6 Stabilization Notes
...
- Fighter profiles with portraits, nationality, records, rankings, detailed skill sheets, camp info, morale, annual overall peaks, and fight history. Opening-universe source markers such as legend, free-agent, and player-seed labels remain subtle in the UI; durable `fighter_id` values still distinguish intentional same-name career snapshots.
