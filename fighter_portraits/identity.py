...
def derived_portrait_identity(fighter):
    ...
    return {
        ...
        "facial_hair": 0 if gender == "Female" else _weighted_trait(fighter_id, "facial_hair", tuple(range(len(FACIAL_HAIR))), (24, 20, 12, 4, 2, 5, 2, 2, 3, 12, 8, 4, 2, 1, 4, 1) + (2,) * 50),
        ...
        "head_w": trait_hash(fighter_id, "head_w", FEATURE_COUNTS["head_w"]), "bg": trait_hash(fighter_id, "bg", len(BACKGROUND)),
        **{key: trait_hash(fighter_id, key, FEATURE_COUNTS[key]) for key in (
